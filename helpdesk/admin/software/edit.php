            ...
            <div class="form">
                <div class="form-panel one">
                    <div class="form-header">
                        <h1>Редактировать  <a style="color: orange; text-decoration: none;" href="../index.php"> &#128938;</a></h1>
                    </div>
                    <div class="form-content">
                            ...
                            <form action="change.php?id=<?php echo $product['id']?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  value="<?php echo $product['sk_name'];?>" type="text" name="sk_name" />
                                </div>
                                <div class="form-group">
                                    <label for="fio">Производитель</label>
                                    <input  value="<?php echo $product['sk_vendor'];?>" type="text" name="sk_vendor" />
                                </div>
                                <div class="form-group">
                                    <label for="fio">Группировка</label>
                                    <input  value="<?php echo $product['groups'];?>" type="text" name="groups" />
                                </div>
                                <div class="form-group">
                                    <label for="fio">Категория</label>
                                    <input  value="<?php echo $product['sk_kind'];?>" type="text" name="sk_kind" />
                                </div>
                                  <div class="form-group">
                                      <label for="fio">Статус</label>
                                      <input  value="<?php echo $product['sk_status'];?>" type="text" name="sk_status" />
                                  </div>
                                  <div class="form-group">
                                      <label for="fio">Лицензия</label>
                                      <input  value="<?php echo $product['sk_lic'];?>" type="text" name="sk_lic" />
                                  </div>
                                  <div class="form-group">
                                      <label for="fio">Версия</label>
                                      <input  value="<?php echo $product['sk_ver'];?>" type="text" name="sk_ver" />
                                  </div>
                                  <div class="form-group">
                                      <label for="fio">Статутс проверки</label>
                                      <input  value="<?php echo $product['sk_proof'];?>" type="text" name="sk_proof" />
                                  </div>

                                    <div class="form-group">
                                        <label for="fio">Акт проверки</label>
                                        <textarea  name="sk_act"  cols="70" rows="3"><?php echo $product['sk_act'];?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="fio">Описание</label>
                                        <textarea  name="sk_desc"  cols="70" rows="6"><?php echo $product['sk_desc'];?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="fio">Путь</label>
                                        <textarea name="sk_path"  cols="70" rows="3"><?php echo $product['sk_path'];?></textarea>
